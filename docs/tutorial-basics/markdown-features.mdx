...
Docusaurus supports [Mermaid](https://mermaid.js.org/) diagrams to create rich visualizations:
...
Simply use the ```mermaid code block syntax to define your diagrams.
